...
#sed -i '/php83Injection/ a\pythonInjection on\' "$RUXIT_CONF_FILE"
sed -i '/\[general\]/ a\pythonInjection on\' "$RUXIT_CONF_FILE"
sed -i '/\[agentType\]/ a\python on\' "$RUXIT_CONF_FILE"
